...
comment :   Make Text File to Json format. 
            ...
            Hyundaimall
verData : 0.0.1 is Init Hyundaimall crawl.
          0.0.2 is Make Hyundaimall crawl roop.
          0.0.3 'll be make refactoring.

Bug : 0.0.1 can be only crawl rank1. It means just one section can be crawled.
      0.0.2 Must be fix roopSystem.
