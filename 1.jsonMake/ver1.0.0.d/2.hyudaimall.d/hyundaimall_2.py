...
import re
hyundai_json = open('./hyundai_json_2.json', 'w')
fileLocation = "./"
"""
...
hyundaimall_url = 'http://www.hyundaihmall.com/front/dpd/wkBestTypeTot.do?dispCsfGrpGbcd=01&mode=sell&sectId=2130193&type=hmall&ajaxYn=Y&depth='
...
def crawling_func(html):
    ...
    for tr in tr_list:
        ...
        price = int(
            tr.find('span', {'class': 'item-price'}).find('strong').text.replace(',', ''))
        price2 = None
        age = None
