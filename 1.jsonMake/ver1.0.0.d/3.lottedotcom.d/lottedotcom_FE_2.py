...
lottedot_json = open('./lottedot_json_FE_2.json', 'w')
fileLocation = "./"
"""
...
lottedotmall_url = 'http://www.lotte.com/display/viewRankingZoneMain.lotte?disp_no=5543628&disp_grp_nm=%ED%8C%A8%EC%85%98%EC%9D%98%EB%A5%98&upr_disp_no=&spick_disp_no=0&goods_sum_sct_cd=R0&goods_rnk_sct_cd=S&gen_sct_cd=F&age_sct_cd=30&dept_yn=&type=pc&tracking=RANKING_Sort_F_30#rankMiddle'
